...
//        1.3 Select Sort By position "Name: Z to A"
          desktopsPage.sortProductByNameZtoA("Name: Z to A");

//        1.4 Verify the Product will be arranged in Descending order.
    List<String> actualProductNames = new ArrayList<>();
    for (WebElement product : desktopsPage.getListOfProduct()) {
...
//2.3 Select Sort By option "Name: A to Z"
    desktopsPage.sortProductByNameZtoA("Name: A to Z");
//            2.4 Click on the "Add To Cart" button of the product name ‘Build your own computer’
              desktopsPage.clickOnAddToCartOfYourSelectedProduct("Build your own computer");
